...
describe('the calculation route', () => {
  it('links back to the task list from above the page', () => {
    ...
    const values = { methodology: '', calculatedBy: '', calculatedByOther: '' };

    expect(handle.backHref({ id, values })).toBe(`/publish/indicators/${id}/task-list`);
  });
});
