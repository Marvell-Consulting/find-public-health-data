...
The pages, route modules and loaders only `internal-web` mounts: the indicators dashboard, the
indicator overview page, topic administration and the manage-data landing page. Loaders call the internal API through the `ApiClient` in
