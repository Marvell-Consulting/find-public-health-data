...
import { type BenchmarkJudgement, benchmarkJudgement, formatCalculatedValue } from '../data.ts';
import type { IndicatorDetail, IndicatorObservation, IndicatorRangePeriod } from '../loader.ts';
