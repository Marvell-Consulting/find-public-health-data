...
/**
 * Workflow YAML only, following a `uses:` into the repository's own composite actions: refuses the
 * route in, whatever the value looks like. Trivy, in CI, checks the built bytes for the patterns it
 * knows.
 */
